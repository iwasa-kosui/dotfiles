// ~/.claude/rules/communication-style.md の観点のうち、語彙で機械的に判定できるものを検査する。
//
...
//
// doc-style-checker サブエージェントは Bash を持たず textlint を実行できないため、
// ~/.claude/agents/doc-style-checker.md に同じ語彙を Grep パターンとして写している。
// ここを変えたらあちらも直す。
 ...
 * doc-style-checker サブエージェントが、判断を添えた指摘としてこれらを見る。
 */
