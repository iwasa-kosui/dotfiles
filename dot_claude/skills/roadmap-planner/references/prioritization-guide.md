...
| 線形減衰型 | 遅れるほど徐々にコストが増加（例: 技術的負債の利子） | 他テーマとの相対比較で順序決定。高優先テーマをブロックする負債の場合、遅延コストはブロック先テーマに転嫁される |
...
| Tech Debt | 10-20% | 計画的な負債返済。tech-debt-registry.md のリスクスコアとブロック関係を考慮して配分を調整する |
